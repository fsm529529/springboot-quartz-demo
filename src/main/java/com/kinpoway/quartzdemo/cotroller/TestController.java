...
public class TestController {
    ...
    public String start(@RequestParam("name") String name) throws Exception {
        ...
        CronScheduleBuilder cronScheduleBuilder = CronScheduleBuilder.cronSchedule(checkOutCron)
    ...
    public String stop(@RequestParam String jobName, @RequestParam String jobGroup) throws Exception {
